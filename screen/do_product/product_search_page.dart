...
import 'detail/product_details_page.dart';

class ProductSearchPage extends StatefulWidget {
  const ProductSearchPage({Key? key, required this.title}) : super(key: key);

  static const String routeName = "/product_search";
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                ...
                Navigator.pushNamed(context, ProductDetailPage.routeName,
                    arguments: vendorService.id);
                //_showSheet();
              },
            )));
  }

  // bottom sheet modal <-flexible scroll
  void _showSheet() {
