...
class YoutubePlayerPage extends StatefulWidget {
  ...
  static const String routeName = "/youtube_player";
...
class YoutubePlayerPageState extends State<YoutubePlayerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return YoutubePlayerControllerProvider(
      ...
      child: Scaffold(
        appBar: WidgetFactory().createDefaultAppBar(context, title: '유투브 영상'),
        body: LayoutBuilder(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _space,
          //MetaDataSection(),
          const Center(child: AutoSizeText('상단 아이콘에 플레이스트를 선택하세요')),
          _space,
          //PlayPauseButtonBar(),
          //VolumeSlider(),
          //PlayerStateSection(),
