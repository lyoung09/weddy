...
class PromotionImagePage extends StatelessWidget {
  const PromotionImagePage({super.key, required this.imageList});

  static const String routeName = "/promotion_image";
