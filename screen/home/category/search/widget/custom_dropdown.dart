  ...
  Widget build(BuildContext context) {
    return DropdownButtonHideUnderline(
      child: DropdownButton2(
        ...
        underline: Images.getIcon('Divider.png',
        ...
        iconStyleData: IconStyleData(
            icon: icon ?? Images.getIcon('Icon_angle_down.png'),
            iconSize: iconSize ?? 12,
            iconEnabledColor: iconEnabledColor,
            iconDisabledColor: iconDisabledColor,
            openMenuIcon: Transform.rotate(
                angle: math.pi, child: Images.getIcon('Icon_angle_down.png'))),
        dropdownStyleData: DropdownStyleData(
          //Max height for the dropdown menu & becoming scrollable if there are more items. If you pass Null it will take max height possible for the items.
          maxHeight: dropdownHeight ?? 180,
          width: dropdownWidth ?? MediaQuery.of(context).size.width * 0.55,
