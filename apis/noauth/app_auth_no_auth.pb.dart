...
export '../common/app_common.pb.dart';
...
class SignupRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set userPlatform($core.String v) {
    $_setString(5, v);
  }
...
class SignupResponse extends $pb.GeneratedMessage {
  ...
  SignupResponse copyWith(void Function(SignupResponse) updates) =>
      super.copyWith((message) => updates(message as SignupResponse))
          as SignupResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ForgotUserIdRequest extends $pb.GeneratedMessage {
  ...
  factory ForgotUserIdRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForgotUserIdRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ForgotUserIdRequest copyWith(void Function(ForgotUserIdRequest) updates) =>
      super.copyWith((message) => updates(message as ForgotUserIdRequest))
          as ForgotUserIdRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ForgotUserIdRequest create() => ForgotUserIdRequest._();
  ForgotUserIdRequest createEmptyInstance() => create();
  static $pb.PbList<ForgotUserIdRequest> createRepeated() =>
      $pb.PbList<ForgotUserIdRequest>();
  @$core.pragma('dart2js:noInline')
  static ForgotUserIdRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForgotUserIdRequest>(create);
...
class ForgotPasswordRequest extends $pb.GeneratedMessage {
  ...
  factory ForgotPasswordRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ForgotPasswordRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ForgotPasswordRequest copyWith(
      ...
      super.copyWith((message) => updates(message as ForgotPasswordRequest))
          as ForgotPasswordRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuthRequest extends $pb.GeneratedMessage {
  ...
  AuthRequest copyWith(void Function(AuthRequest) updates) =>
      super.copyWith((message) => updates(message as AuthRequest))
          as AuthRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IsDuplicatedIdRequest extends $pb.GeneratedMessage {
  ...
  factory IsDuplicatedIdRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IsDuplicatedIdRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  IsDuplicatedIdRequest clone() =>
      IsDuplicatedIdRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  IsDuplicatedIdRequest copyWith(
          void Function(IsDuplicatedIdRequest) updates) =>
      super.copyWith((message) => updates(message as IsDuplicatedIdRequest))
          as IsDuplicatedIdRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IsDuplicatedIdRequest create() => IsDuplicatedIdRequest._();
  IsDuplicatedIdRequest createEmptyInstance() => create();
  static $pb.PbList<IsDuplicatedIdRequest> createRepeated() =>
      $pb.PbList<IsDuplicatedIdRequest>();
  @$core.pragma('dart2js:noInline')
  static IsDuplicatedIdRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IsDuplicatedIdRequest>(create);
...
class IsDuplicatedIdResponse extends $pb.GeneratedMessage {
  ...
  factory IsDuplicatedIdResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IsDuplicatedIdResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  IsDuplicatedIdResponse clone() =>
      IsDuplicatedIdResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  IsDuplicatedIdResponse copyWith(
          void Function(IsDuplicatedIdResponse) updates) =>
      super.copyWith((message) => updates(message as IsDuplicatedIdResponse))
          as IsDuplicatedIdResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IsDuplicatedIdResponse create() => IsDuplicatedIdResponse._();
  IsDuplicatedIdResponse createEmptyInstance() => create();
  static $pb.PbList<IsDuplicatedIdResponse> createRepeated() =>
      $pb.PbList<IsDuplicatedIdResponse>();
  @$core.pragma('dart2js:noInline')
  static IsDuplicatedIdResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IsDuplicatedIdResponse>(create);
  static IsDuplicatedIdResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get isDuplicatedId => $_getBF(0);
  @$pb.TagNumber(1)
  set isDuplicatedId($core.bool v) {
    $_setBool(0, v);
  }
